 ...
 * @return {object}
 */
const getScenicSpotByCityAPI = async ({
  signal = undefined,
  top = undefined,
  skip = undefined,
  ...
  await axios
    .get(`https://${API_HOSTNAME_URL}/v2/Tourism/ScenicSpot/${city}`, {
    ...
    .then(function (response) {
      // console.log(`取得${city}觀光景點資料:`, response); //FIXME:
...
export default getScenicSpotByCityAPI;
