 ...
 * @return {object}
 */
const getRestaurantByCityAPI = async ({
  signal = undefined,
  top = undefined,
  skip = undefined,
  ...
  await axios
    .get(`https://${API_HOSTNAME_URL}/v2/Tourism/Restaurant/${city}`, {
    ...
    .then(function (response) {
      // console.log(`取得${city}觀光餐飲資料:`, response); //FIXME:
...
export default getRestaurantByCityAPI;
