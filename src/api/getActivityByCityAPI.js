 ...
 * @return {object}
 */
const getActivityByCityAPI = async ({
  signal = undefined,
  top = undefined,
  skip = undefined,
  ...
  await axios
    .get(`https://${API_HOSTNAME_URL}/v2/Tourism/Activity/${city}`, {
    ...
    .then(function (response) {
      // console.log(`取得${city}觀光活動資料:`, response); //FIXME:
...
export default getActivityByCityAPI;
